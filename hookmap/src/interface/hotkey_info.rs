use crate::hotkey::{Action, HotkeyInfo, Modifier, MouseEventHandler, TriggerAction};
use hookmap_core::{Button, ButtonEvent, EventBlock};
use std::sync::Arc;
...
impl ConditionalHotkeyInfo {
    pub(super) fn build_partial_hotkey_info(self, trigger: Button) -> PartialHotkeyInfo {
        PartialHotkeyInfo {
            trigger,
